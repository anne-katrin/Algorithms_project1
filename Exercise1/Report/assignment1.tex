...
\author{Anne-Katrin Krolovitch \\ \mail{mail@gmail.com}\\ \and
...
%% Jag kommenterade ut detta eftersom vår elementary operation är det som vi har definerat som tar tid 1 i algorithmerna och detta kan skrivas i samband med complexity delarna
