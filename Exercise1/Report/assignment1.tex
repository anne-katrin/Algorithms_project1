...
Optimal set:  O=\{i1, i2, ... im\} (NOTE: the 1, 2 and m should be on the bottom of the i)\\
Greedy set :  A=\{j1, j2, ... jk\} (NOTE: the 1, 2 and k should be on the bottom of the j)\\

each i and each j consist of a size and a value \\

Claim = (the sum of the values of) jk >= (the sum of the values of) im
