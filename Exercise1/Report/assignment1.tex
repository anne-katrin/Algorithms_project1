...
For the set $S = \{a,b,c\}$ a correct power set for S would be $P = \{\{\},\{a\},\{b\},\{c\},\{a,b\},\{a,c\},\{b,c\},\{a,b,c\}$.

The createPowerset part of the algorithm has to make sure each of subset in set $P$ is created. 
